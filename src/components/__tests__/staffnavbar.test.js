...
import StaffNavbar from '../staff/StaffNavbar.vue';
...
describe('StaffNavbar.vue', () => {
  ...
  //       expect(wrapper.find('.fw-bold').text()).toBe('Staff Portal');
  //       expect(wrapper.findAll('a.nav-link')).toHaveLength(4);
